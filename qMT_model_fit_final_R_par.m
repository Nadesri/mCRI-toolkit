...
function [fv rnrm] = qMT_model_fit_final_R_par( data_MT, MT_Off_Freq, alpha_MT, alpha_0, t_r, t_m, t_s, pulse_type, line_shape, table_update, B0, B1, B1_MT,  mode, in15, in16, TR_SPGR, t_m_SPGR)
    ...
    parfor i=1:labsize
        [fvp{i} rnrmp{i}] = qMT_model_fit_final_R(data_MTp{i}, MT_Off_Freq, alpha_MT, alpha_0, t_r, t_m, t_s, pulse_type, line_shape, table_update, B0p{i}, B1p{i}, B1_MTp{i},  mode, in15p{i}, in16p{i}, TR_SPGR, t_m_SPGR);
    end
