...
% Wrapper for qMT_residuals
    function residual = qMT_SPGR_Signal_Wrapper(x)
        ...
        S_MT = qMT_Signal_final_R1F_R(x(3,1), x(4,1), vox_alpha_0', t_m', t_s, t_r', x(1,1), x(2,1), W_B*0, W_F*0) - ...
            qMT_Signal_final_R1F_R(x(3,1), x(4,1), vox_alpha_0', t_m', t_s, t_r', x(1,1), x(2,1), W_B, W_F);
    ...
    function residual = qMT_Signal_Wrapper(x)
        ...
        S_MT = qMT_Signal_final_R1F_R(x(1,1), x(2,1), vox_alpha_0', t_m', t_s, t_r', vox_PD, R1_F, W_B*0, W_F*0)- ...
            qMT_Signal_final_R1F_R(x(1,1), x(2,1), vox_alpha_0', t_m', t_s, t_r', vox_PD, R1_F, W_B, W_F);
